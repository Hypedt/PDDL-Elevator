...
(accessible ?elevator - elevator ?floor - floor)
;; see if elevator can go to this floor
...
(:action up
  ...
  :precondition (and (lift-at ?e ?f1) (above ?f1 ?f2) (accessible ?e ?f2))
...
(:action down
  :parameters (?e - elevator ?f1 - floor ?f2 - floor)
  :precondition (and (lift-at ?e ?f1) (above ?f2 ?f1) (accessible ?e ?f2))
  :effect (and (lift-at ?e ?f2) (not (lift-at ?e ?f1))  ))
